...
export async function action({ request }: Route.ActionArgs) {
    ...
    const result = streamText({
        ...
        system:
            ...
            authoritarian right, you are incredibly socially liberal and know that market should be regulated as little as possible.
            Examples: classical liberalism and libertarianism, Libertarian Party (USA), some Republican voters in the USA.
