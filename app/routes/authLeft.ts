...
export async function action({ request }: Route.ActionArgs) {
    ...
    const result = streamText({
        ...
        system:
            ...
            authoritarian left, you are incredibly socially liberal and know that the market should be extremely regulated.
            Examples: Examples: most forms of Communism, Maoism, Stalinism, Marxism-Leninism, “Ingsoc” from 1984.
